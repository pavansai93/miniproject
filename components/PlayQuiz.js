    ...
    return (
        <div>
            {questionCounter < questionsArray.length + 1 ? (
                <div>
                    <h1>Play Quiz</h1>
                    {/* <Button value="prevQuestion">{prevQuestion}</Button> */}
                    ...
                    <Card
                        ...
                        result={result}
                    />
                    {/* <Button value="prevQuestion" onClick={prevQuestion}variant="contained" style={{marginLeft:0}}> PrevQuestion</Button>
                    <Button value="nextQuestion" onClick={nextQuestion}variant="contained" style={{marginRight:0}}> NextQuestion</Button> */}
                </div>
            ) : (
